...
def create_law(db: Session, law: schemas.law.LawCreate) -> models.Law:
...
def update_law(
    db: Session, law_id: int, law_update: schemas.law.LawUpdate
) -> models.Law:
...
def delete_law(db: Session, law_id: int):
    law = get_law(db, law_id)
