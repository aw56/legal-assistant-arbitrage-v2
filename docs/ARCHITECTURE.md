...
Проект **Legal Assistant Arbitrage v2** — это модульное FastAPI-приложение, построенное на принципах чистой архитектуры и предназначенное для автоматизации юридических задач в арбитражных делах.
