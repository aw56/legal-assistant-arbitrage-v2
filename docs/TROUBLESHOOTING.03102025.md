Вот подробная “послематчевая” документация: что сделали, с какими проблемами столкнулись, как диагностировали и чем всё закончилось. Сохрани (и положи в `docs/i\
